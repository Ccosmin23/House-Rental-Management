...
public class CAdmin implements Initializable, Observer {
    ...
    public void init() {
        ...
        initEmployeeTable();
        displayEmployeeTable(model.getsEmployee().readEmployee());
    ...
    public void createEmployee() throws IOException {
        ...
        model.getsEmployee().addEmployee(employee);
    ...
    public void deleteEmployee() {
        employee = selectEmployee();
        model.getsEmployee().deleteEmployee(employee);
    ...
    public void updateEmployee() throws IOException {
        ...
        model.getsEmployee().updateEmployee(employee, employee2);
    ...
    public MAdmin getModel() {
        return model;
    }

    public void setModel(MAdmin model) {
        this.model = model;
    }
    ...
    public void displayEmployeeTable(List<Employee> employees) {
        ObservableList<Employee> employee_list = FXCollections.observableArrayList(employees);
